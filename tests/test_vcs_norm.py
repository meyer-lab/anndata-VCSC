...
from vcsc import VCSCArray, VCSCArrayNormalized, VCSRArray, VCSRArrayNormalized
...
def test_scatter_matmul_under_tiny_memory_budget_matches_reference(dense, vcls, monkeypatch):
