...
(see :mod:`anndata_sc._construct`) -- so packing is free to sort each group
...
This module only implements the byte codec; :mod:`anndata_sc._io` uses it to decode
...
:mod:`anndata_sc._ops` need to know this encoding exists.
